...
const danceabilityAvg = (danceabilityArr?.reduce((a, b) => a + b, 0) / danceabilityArr?.length) * 100;
...
// averages of each score
const energyAvg = (energyArr?.reduce((a, b) => a + b, 0) / energyArr?.length) * 100;
  return energyAvg;
}
...
// averages of each score
const valenceAvg = (valenceArr?.reduce((a, b) => a + b, 0) / valenceArr?.length) * 100;
  return valenceAvg;
}
...
// averages of each score
const danceabilityAvg = danceabilityArr?.reduce((a, b) => a + b, 0) / danceabilityArr?.length;
const energyAvg = energyArr?.reduce((a, b) => a + b, 0) / energyArr?.length;
const valenceAvg = valenceArr?.reduce((a, b) => a + b, 0) / valenceArr?.length;
